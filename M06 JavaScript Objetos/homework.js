...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for (i = 0 ; i < objetoUsuario.posts.length ; i++) {
      cantLikes = cantLikes + objetoUsuario.posts[i].likes;
   }
   return cantLikes;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.precio * porcentajeDeDescuento 
   }
   // precioFinal = objetoProducto.precio - objetoProducto.calcularPrecioDescuento
